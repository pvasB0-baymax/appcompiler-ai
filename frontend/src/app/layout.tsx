...
export const metadata: Metadata = {
  title: 'AppCompilerAI - Natural Language App Compiler',
  description: 'Convert natural language requirements into deterministic, validated, executable specifications with self-repair feedback loops.',
};
